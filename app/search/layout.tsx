...
export default function SearchLayout({
  ...
  return (
    <main className="h-screen flex flex-col md:flex-row overflow-hidden relative">
      ...
      <aside className="w-full md:w-[30vw] lg:w-[20vw] h-[60vh] md:h-full border-r border-gray-200 p-4 overflow-y-auto bg-white z-40">
        <div className="mb-6">
      ...
      <button
        className="md:hidden absolute bottom-4 right-4 z-50 bg-white p-2 rounded-full shadow-md"
